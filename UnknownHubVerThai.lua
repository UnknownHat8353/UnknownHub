...
elseif game.PlaceId == 7449423635 then
    ...
    game:GetService("Players").LocalPlayer:Kick("ไม่สนับสนุน รอสักครู่...")
end
            ...
            if IslandESP then 
                if v.Name ~= "ทะเล" then
                    if not v:FindFirstChild('NameEsp') then
                        ...
                        v['NameEsp'].TextLabel.Text = (v.Name ..'   \n'.. round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Position).Magnitude/3) ..' ระยะทาง')
                    end
                end
            else
...
for i,v in pairs(game:GetService'ผู้เล่น':GetChildren()) do
    pcall(function()
        if not isnil(v.Character) then
            if ESPPlayer then
                if not isnil(v.Character.Head) and not v.Character.Head:FindFirstChild('NameEsp'..Number) then
                    ...
                    name.FontSize = "Size14"
                    name.TextWrapped = true
                    name.Text = (v.Name ..' \n'.. round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Character.Head.Position).Magnitude/3) ..' ระยะทาง')
                    name.Size = UDim2.new(1,0,1,0)
                    name.TextYAlignment = 'Top'
                    name.BackgroundTransparency = 1
                    name.TextStrokeTransparency = 0.5
                    ...
                    v.Character.Head['NameEsp'..Number].TextLabel.Text = (v.Name ..' | '.. round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Character.Head.Position).Magnitude/3) ..' ระยะทาง\nเลือด : ' .. round(v.Character.Humanoid.Health*100/v.Character.Humanoid.MaxHealth) .. '%')
                end
            else
...
for i,v in pairs(game.Workspace:GetChildren()) do
    pcall(function()
        if string.find(v.Name,"หีบ") then
            if ChestESP then
                if string.find(v.Name,"หีบ") then
...
for i,v in pairs(game.Workspace:GetChildren()) do
    pcall(function()
        if DevilFruitESP then
            if string.find(v.Name, "ผลไม้") then   
                if not v.Handle:FindFirstChild('NameEsp'..Number) then
                    ...
                    name.Text = (v.Name ..' \n'.. round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Handle.Position).Magnitude/3) ..' ระยะทาง')
                else
...
for i,v in pairs(game.Workspace:GetChildren()) do
    pcall(function()
        if v.Name == "ดอกไม้2" or v.Name == "ดอกไม้1" then
            if FlowerESP then 
                if not v:FindFirstChild('NameEsp'..Number) then
                    local bill = Instance.new('BillboardGui',v)
                    bill.Name = 'NameEsp'..Number
                    ...
                    if v.Name == "ดอกไม้1" then 
                        name.Text = ("ดอกไม้สีฟ้า" ..' \n'.. round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Position).Magnitude/3) ..' ระยะทาง')
                        name.TextColor3 = Color3.fromRGB(0, 0, 255)
                    end
                    if v.Name == "ดอกไม้2" then
                        name.Text = ("ดอกไม้สีแดง" ..' \n'.. round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Position).Magnitude/3) ..' ระยะทาง')
                        name.TextColor3 = Color3.fromRGB(255, 0, 0)
                    end
                else
                    v['NameEsp'..Number].TextLabel.Text = (v.Name ..'   \n'.. round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Position).Magnitude/3) ..' ระยะทาง')
    ...
    if v:IsA("Tool") then
        if RealFruitESP then 
            if not v.Handle:FindFirstChild('NameEsp'..Number) then
                ...
                v.Handle['NameEsp'..Number].TextLabel.Text = (v.Name ..' '.. round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Handle.Position).Magnitude/3) ..' ระยะทาง')
            end
        else
            if v.Handle:FindFirstChild('NameEsp'..Number) then
                v.Handle:FindFirstChild('NameEsp'..Number):Destroy()
        ...
        if MobESP then
            for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                if v:FindFirstChild('HumanoidRootPart') then
                    ...
                    v.MobEap.TextLabel.Text = v.Name.." - "..Dis.." ระยะทาง"
                end
            end
        else
            for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
        ...
        if SeaESP then
            for i,v in pairs(game:GetService("Workspace").SeaBeasts:GetChildren()) do
                if v:FindFirstChild('HumanoidRootPart') then
                    ...
                    local Dis = math.floor((game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v.HumanoidRootPart.Position).Magnitude)
                    v.Seaesps.TextLabel.Text = v.Name.." - "..Dis.." ระยะทาง"
                end
            end
        else
            for i,v in pairs (game:GetService("Workspace").SeaBeasts:GetChildren()) do
        ...
        if NpcESP then
            for i,v in pairs(game:GetService("Workspace").NPCs:GetChildren()) do
                if v:FindFirstChild('HumanoidRootPart') then
                    ...
                    local Dis = math.floor((game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v.HumanoidRootPart.Position).Magnitude)
                    v.NpcEspes.TextLabel.Text = v.Name.." - "..Dis.." ระยะทาง"
                end
            end
        else
            for i,v in pairs (game:GetService("Workspace").NPCs:GetChildren()) do
...
for i,v in pairs(game:GetService("Workspace").NPCs:GetChildren()) do
    pcall(function()
        if AfdESP then 
            if v.Name == "คนขายผลปีศาจขั้นสูง" then
                if not v:FindFirstChild('NameEsp') then
                    local bill = Instance.new('BillboardGui',v)
                    bill.Name = 'NameEsp'
                    bill.ExtentsOffset = Vector3.new(0, 1, 0)
...
function TweenTempleLegit()
		...
		for r, v in pairs(AllNPCS) do
			if v.Name == "พลังลึกลับ" then
				TempleMysteriousNPC1 = v
			end
			if v.Name == "พลังลึกลับ3" then
		...
		if
			(TempleMysteriousNPC2.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <
				15
		 then
			game.ReplicatedStorage.Remotes.CommF_:InvokeServer("ความคืบหน้าเผ่า V4", "วาปกลับ")
		end
		if
			(TempleMysteriousNPC1.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <
				15
		 then
			game.ReplicatedStorage.Remotes.CommF_:InvokeServer("ความคืบหน้าเผ่า V4", "วาป")
         end
	end
...
CamShake:Stop()
    ...
    function function8()
        ...
        if CheckMoon() == "Full Moon" and ao <= 5 then
            return tostring(function6()) .. " ( ดวงจันทร์จะสิ้นสุดใน " .. math.floor(5 - ao) .. " นาที )"
        elseif CheckMoon() == "Full Moon" and (ao > 5 and ao < 12) then
            return tostring(function6()) .. " ( ดวงจันทร์ปลอม )"
        elseif CheckMoon() == "Full Moon" and (ao > 12 and ao < 18) then
            return tostring(function6()) .. " ( ดวงจันทร์เต็มดวงจะอยู่ใน " .. math.floor(18 - ao) .. " นาที )"
        elseif CheckMoon() == "Full Moon" and (ao > 18 and ao <= 24) then
            return tostring(function6()) .. " ( ดวงจันทร์จะสิ้นสุดใน " .. math.floor(24 + 6 - ao) .. " นาที )"
        end
        if CheckMoon() == "Next Night" and ao < 12 then
            return tostring(function6()) .. " ( พระจันทร์เต็มดวงจะอยู่ใน " .. math.floor(18 - ao) .. " นาที )"
        elseif CheckMoon() == "Next Night" and ao > 12 then
            return tostring(function6()) .. " ( พระจันทร์เต็มดวงจะอยู่ใน " .. math.floor(18 + 12 - ao) .. " นาที )"
        end
    ...
    function CheckAcientOneStatus()
        if not game.Players.LocalPlayer.Character:FindFirstChild("RaceTransformed") then
            return "คุณยังต้องบรรลุความยิ่งใหญ่"
        end
        local v227 = nil
        local v228 = nil
        local v229 = nil
        v229, v228, v227 = game.ReplicatedStorage.Remotes.CommF_:InvokeServer("อัพเกรดเผ่า", "ตรวจสอบ")
        if v229 == 1 then
            return "จำเป็นต้องฝึกเพิ่ม"
        elseif v229 == 2 or v229 == 4 or v229 == 7 then
            return "สามารถซื้อเกียร์ด้วย " .. v227 .. " เงินม่วง"
        elseif v229 == 3 then
            return "จำเป็นต้องฝึกเพิ่ม"
        elseif v229 == 5 then
            return "คุณเสร็จการแข่งขันของคุณแล้ว"
        elseif v229 == 6 then
            return "อัพเกรดเสร็จแล้ว: " .. v228 - 2 .. "/3, ต้องการเพิ่ม"
        end
        if v229 ~= 8 then
            if v229 == 0 then
                return "พร้อมสำหรับการทดลองใช้"
            else
                return "คุณยังต้องบรรลุความยิ่งใหญ่"
            end
        end
        return "ที่เหลืออยู่ " .. 10 - v228 .. " เซสชันการฝึกอบรม"
    end

spawn(function()
    while wait() do
        for i,v in pairs(game.Players.LocalPlayer:GetChildren()) do
            if v.Name == "โหลดข้อมูลแล้ว" or v.Name == "ข้อมูลพรีโหลด" then
                v:Destroy()
            end
        end
    end
...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>UnknownHat8353 Hub สวัสดี<Color=/>"):Display()
    wait(.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>เข้าร่วม Discord ของเราเพื่อรับข้อมูลการอัปเดตล่าสุด<Color=/>"):Display()
    wait(.29)
end)

local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "UnknownHat8353 Hub", HidePremium = false, IntroText = "UnknownHat8353 Hub⚜️", SaveConfig = true, ConfigFolder = "NightHub"})



OrionLib:MakeNotification({
    Name = "UnknownHat8353 Hub",
    Content = "กรุณารอสักครู่เพื่อโหลดสคริปต์...,อย่าเปิดใช้งานฟังก์ชั่นใดๆ",
    Image = "rbxassetid://10790918487",
    Time = 5
})
wait(3)
OrionLib:MakeNotification({
    Name = "UnknownHat8353 Hub",
    Content = "รอให้ Hub โหลด config ก่อนใช้งาน",
    Image = "rbxassetid://10790918487",
    Time = 10
})
...
W:AddLabel("UnknownHat8353 & MeN0Name515")
...
W:AddLabel("พัฒนาโดย")
W:AddLabel("UnknownHat8353 & MeN0Name515")
W:AddLabel("Discord WeNoName")
local Section = W:AddSection({
    Name = "สถานะ"
})

local locallv = W:AddLabel("เลเวล")
    ...
    local localrace = W:AddLabel("เผ่า")
    ...
    local localbeli = W:AddLabel("เงิน")
    ...
    local localfrag = W:AddLabel("เงินม่วง")
    ...
    spawn(function()
        while wait() do
            pcall(function()
                localexp:Set("จำนวน ExP :".." "..game:GetService("Players").LocalPlayer.Data.Exp.Value)
            end)
        end
    end)
    
    local localstat = W:AddLabel("จำนวน สแต็ส")
    
    spawn(function()
        while wait() do
            pcall(function()
                localstat:Set("จำนวน สแต็ส :".." "..game:GetService("Players").LocalPlayer.Data.Points.Value)
            end)
        end
    end)
    
    local localbountyhornor = W:AddLabel("ค่าหัว")
    
    spawn(function()
        while wait() do
            pcall(function()
                localbountyhornor:Set("ค่าหัว / เกียรติ :".." "..game:GetService("Players").LocalPlayer.leaderstats["ค่าหัว/เกียรติ"].Value)
            end)
        end
    end)
    
    local localDevil = W:AddLabel("ผลไม้ปีศาจ")
    ...
    W:AddLabel("บันทึกการกำหนดค่า : เร็วๆ นี้...")
    local Farmfast = W:AddLabel("ฟาร์มเร็ว : ❌")
    local Bypass = W:AddLabel("Bypass ❌")
    local Section = W:AddSection({
        Name = "โลก"
    })
    local WolrdSet3 = W:AddLabel("โลก 1 ❌ ")
    local WolrdSet = W:AddLabel("โลก : 2 ❌")
    local WolrdSet1 = W:AddLabel("โลก : 3 ❌")
    local Section = W:AddSection({
        Name = "จำนวนสแต็ส"
    })
    ...
    local   BartiloQuest =            W:AddLabel("❌ : ภารกิจ Bartilo")
    local   DonSwanQuest =             W:AddLabel("❌ : ภารกิจ Don Swan")
    local    KillDonSwan =           W:AddLabel("❌ : ฆ่า Don Swan")
...
local WeaponList = {"หมัด","ดาบ","ผลไม้","ปืน"}
_G.SelectWeapon = "หมัด"
M:AddDropdown({
    Name = "เลือกอาวุธ",
    Default = "",
    Options = WeaponList,
    ...
    while wait() do
        pcall(function()
            ...
            elseif _G.SelectWeapon == "ปืน" then
                for i ,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
                    if v.ToolTip == "ปืน" then
                        if game.Players.LocalPlayer.Backpack:FindFirstChild(tostring(v.Name)) then
                            _G.SelectWeapon = v.Name
                        end
                    end
                end
            elseif _G.SelectWeapon == "ผลไม้" then
                for i ,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
                    if v.ToolTip == "ผลไม้" then
                        if game.Players.LocalPlayer.Backpack:FindFirstChild(tostring(v.Name)) then
                            _G.SelectWeapon = v.Name
                        end
                    end
...
if World2 and World1 then
    ...
    M:AddButton({
        ...
        Callback = function()
            pcall(function()
                ...
                l.FogEnd = 9e9
                l.Brightness = 0
                settings().Rendering.QualityLevel = "เลเวล01"
    ...
    local Section = M:AddSection({
        Name = "ฟาร์มอื่นๆOther Farmฟาร์มอื่นๆ"
    })
...
local Section = M:AddSection({
    Name = "เมนูความเชี่ยวชาญ"
})



M:AddToggle({
    Name = "ฟาร์ม BF อัตโนมัติ",
    Default = false,
    Flag = "ความเชี่ยวชาญ",
    Save = true,
    Callback = function(Value)
...
M:AddToggle({
    Name = "ฟาร์มความเชี่ยวชาญ ปืน อัตโนมัติ",
    Default = false,
    Flag = "ความเชี่ยวชาญ ปืน",
    Save = true,
    Callback = function(Value)
...
spawn(function()
    while wait(.1) do
        if _G.BringMode then
            pcall(function()
                if _G.BringMode == "ต่ำ" then
                    _G.BringMode = 300
                elseif _G.BringMode == "ปกติ" then
                    _G.BringMode = 375
                elseif _G.BringMode == "สูง" then
                    _G.BringMode = 450
                end
            end)
        end
...
M:AddDropdown({
	Name = "โจมตีเร็ว Delay",
	Default = "0.5",
	Options = AttackList,
    Flag = "โจมตีเร็ว Delay",
    Save = true,
	Callback = function(Value)
...
local Section = M:AddSection({
    Name = "ฟาร์มเร็ว : Lv 10 => 120"
})

Farmfasttoggle = M:AddToggle({
    Name = "ฟาร์มเร็วอัตโนมัติ",
    Default = false,
    Flag = "ฟาร์มเร็ว",
    Save = true,
    Callback = function(Value)
...
local Section = M:AddSection({
    Name = "ฟาร์มที่ใกล้ที่สุด"
})

M:AddToggle({
    Name = "ฟาร์มที่ใกล้ที่สุดอัตโนมัติ",
    Default = false,
    Flag = "ฟาร์มที่ใกล้ที่สุดอัตโนมัติ",
    Save = true,
    Callback = function(Value)
...
TweenChest = M:AddToggle({
        Name = "ฟาร์มหีบอัตโนมัติ [MUP]",
        Default = false,
        Flag = "ฟาร์มหีบอัตโนมัติ",
        Save = true,
        Callback = function(Value)
            AutoFarmChest = Value
    ...
    M:AddToggle({
        Name = "ฟาร์มหีบอัตโนมัติ [Bypass]",
        Default = false,
        Flag = "ฟาร์มหีบอัตโนมัติ [Bypass]",
        Save = true,
        Callback = function(Value)
...
M:AddToggle({
    Name = "หยุดแค่ Dark Key หรือ God's Chalice เท่านั้น",
    Default = false,
    Flag = "หยุดแค่ Dark Key หรือ God's Chalice เท่านั้น",
    Save = true,
    Callback = function(Value)
        _G.StopChest = Value
    end    
...
spawn(function()
    ...
    if _G.StopChest then
        if game.Players.LocalPlayer.Backpack:FindFirstChild("หมัดแห่งความมืด") or game.Players.LocalPlayer.Character:FindFirstChild("หมัดแห่งความมืด") or game.Players.LocalPlayer.Backpack:FindFirstChild("ถ้วยของพระเจ้า") or game.Players.LocalPlayer.Character:FindFirstChild("ถ้วยของพระเจ้า") then
            AutoFarmChest = false
            StopTween(AutoFarmChest)
...
local Bone = M:AddLabel("กระดูก : ")

spawn(function()
    while wait() do
        pcall(function()
            Bone:Set("กระดูกที่คุณมี : "..(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("กระดูก","ตรวจสอบ")))
        end)
    end
end)

ToggleBone = M:AddToggle({
    Name = "ฟาร์มกระดูกอัตโนมัติ",
    Default = false,
    Flag = "ฟาร์มกระดูกอัตโนมัติ",
    Save = true,
    Callback = function(Value)
        _G.Auto_Bone = Value
...
ToggleRandom = M:AddToggle({
        Name = "กระดูกสุ่มอัตโนมัติ",
        Default = false,
        Flag = "กระดูกสุ่มอัตโนมัติ",
        Save = true,
        Callback = function(Value)
        ...
        pcall(function()
            while wait(.1) do
                if _G.Auto_Random_Bone then    
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("กระดูก","ซื้อ",1,1)
                end
            end
        end)
    end)
...
local EliteProgress = M:AddLabel("")
    ...
    spawn(function()
        pcall(function()
            while wait() do
                EliteProgress:Set("ความก้าวหน้าของผู้ลากมากดี : "..game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("นักล่าผู้ลากมากดี","ความคืบหน้า"))
            end
        end)
    end)

    M:AddToggle({
        Name = "ผู้ลากมากดีอัตโนมัติ",
        Default = false,
        Flag = "ผู้ลากมากดีอัตโนมัติ",
        Save = true,
        Callback = function(Value)
    ...
    M:AddToggle({
        Name = "โรงงานอัตโนมัติ",
        Default = false,
        Flag = "โรงงานอัตโนมัติ",
        Save = true,
        Callback = function(Value)
        ...
        local Section = M:AddSection({
            Name = "เมนู Dough King"
        })
        

        M:AddToggle({
            Name = "Katakuri อัตโนมัติ",
            Default = false,
            Flag = "Katakuri อัตโนมัติ",
            Save = true,
            Callback = function(Value)
        ...
        M:AddToggle({
            Name = "อัตโนมัติ Katakuri v2",
            Default = false,
            Flag = "อัตโนมัติ Katakuri v2",
            Save = true,
            Callback = function(Value)
        ...
        M:AddToggle({
            Name = "อัตโนมัติ Katakuri v2[HOP]",
            Default = false,
            Flag = "อัตโนมัติ Katakuri v2[HOP]",
            Save = true,
            Callback = function(Value)
                _G.Hop = Value
            end    
...
local Section = M:AddSection({
    ...
    M:AddToggle({
        Name = "ฟาร์ม อาคิสังเกต อัตโนมัติ",
        Default = false,
        Flag = "ฟาร์ม อาคิสังเกต อัตโนมัติ",
        Save = true,
        Callback = function(Value)
    ...
    M:AddToggle({
        Name = "ฟาร์ม อาคิสังเกต อัตโนมัติ[HOP]",
        Default = false,
        Flag = "ฟาร์ม อาคิสังเกต อัตโนมัติ[HOP]",
        Save = true,
        Callback = function(Value)
    ...
    M:AddToggle({
        Name = "Death Step อัตโนมัติ",
        Default = false,
        Flag = "Death Step อัตโนมัติ",
        Save = true,
        Callback = function(Value)
    ...
    M:AddToggle({
        Name = "SharkMan Karate อัตโนมัติ",
        Default = false,
        Flag = "SharkMan อัตโนมัติ",
        Save = true,
        Callback = function(Value)
 ...
 M:AddToggle({
        Name = "Electric Claw อัตโนมัติ",
        Default = false,
        Flag = "Electric Claw อัตโนมัติ",
        Save = true,
        Callback = function(Value)
    ...
    M:AddToggle({
        Name = "Dragon Talon อัตโนมัติ",
        Default = false,
        Flag = "Dragon Talon อัตโนมัติ",
        Save = true,
        Callback = function(Value)
    ...
    M:AddToggle({
        Name = "GodHuman อัตโนมัติ",
        Default = false,
        Flag = "GodHuman อัตโนมัติ",
        Save = true,
        Callback = function(Value)
...
local SaberBoss = IQ:AddLabel("Boss เซเบอร์ : ")
spawn(function()
    while wait() do
        pcall(function()
            if game:GetService("ReplicatedStorage"):FindFirstChild("ผู้เชี่ยวชาญเรื่องดาบ") or game:GetService("ReplicatedStorage"):FindFirstChild("ผู้เชี่ยวชาญเรื่องดาบ") or game:GetService("ReplicatedStorage"):FindFirstChild("ผู้เชี่ยวชาญเรื่องดาบ") or game:GetService("Workspace").Enemies:FindFirstChild("ผู้เชี่ยวชาญเรื่องดาบ") or game:GetService("Workspace").Enemies:FindFirstChild("ผู้เชี่ยวชาญเรื่องดาบ") or game:GetService("Workspace").Enemies:FindFirstChild("ผู้เชี่ยวชาญเรื่องดาบ") then
                SaberBoss:Set("Boss เซเบอร์ : ✅ เกิด")
            else
                SaberBoss:Set("Boss เซเบอร์ : ❌ ไม่เกิด")
            end
        end)
    end
end)
...
IQ:AddToggle({
    Name = "ออโต้ เซเบอร์[HOP]",
    Default = false,
    Flag = "ออโต้ เซเบอร์[HOP]",
    Save = true,
    Callback = function(Value)
        _G.Hop = Value
    end    
    ...
    while wait() do
        pcall(function()
            if game:GetService("ReplicatedStorage"):FindFirstChild("Thunder God") or game:GetService("ReplicatedStorage"):FindFirstChild("Thunder God") or game:GetService("ReplicatedStorage"):FindFirstChild("Thunder God") or game:GetService("Workspace").Enemies:FindFirstChild("Thunder God") or game:GetService("Workspace").Enemies:FindFirstChild("Thunder God") or game:GetService("Workspace").Enemies:FindFirstChild("Thunder God") then
                PoleBoss:Set("Boss Thunder : ✅ เกิด")
            else
                PoleBoss:Set("Boss Thunder : ❌ ไม่เกิด")
            end
        end)
    end
end)
...
TogglePolev1Hop = IQ:AddToggle({
    Name = "Pole V.1 อัตโนมัติ[HOP]",
    Default = false,
    Flag = "Pole อัตโนมัติ[HOP]",
    Save = true,
    Callback = function(Value)
...
IQ:AddToggle({
    Name = "ทะเลที่สองอัตโนมัติ",
    Default = false,
    Flag = "ทะเลที่สองอัตโนมัติ",
    Save = true,
    Callback = function(Value)
...
IQ:AddToggle({
    Name = "แวมไพร์งอัตโนมัติ",
    Default = false,
    Flag = "แวมไพร์งอัตโนมัติ",
    Save = true,
    Callback = function(Value)
...
IQ:AddToggle({
    Name = "SuperHuman อัตโนมัติ",
    Default = false,
    Flag = "SuperHuman อัตโนมัติ",
    Save = true,
    Callback = function(Value)
        _G.AutoSuperhuman = Value
...
BartiloToggle = IQ:AddToggle({
    Name = "เควส Bartilo อัตโนมัติ",
    Default = false,
    Flag = "Bartilo อัตโนมัติ",
    Save = true,
    Callback = function(Value)
        _G.AutoBartilo = Value
...
local Section = IQ:AddSection({
    Name = "ทะเลถัดไปที่สาม"
})


IQ:AddToggle({
    Name = "ทะเลที่สามอัตโนมัติ",
    Default = false,
    Flag = "ทะเลที่สามอัตโนมัติ",
    Save = true,
    Callback = function(Value)
...
IQ:AddToggle({
    Name = "ซื้อ Legend Sword อัตโนมัติ",
    Default = false,
    Flag = "ตำนานอัตโนมัติ",
    Save = true,
    Callback = function(Value)
...
IQ:AddToggle({
    Name = "Buddy Sword อัตโนมัติ",
    Default = false,
    Flag = "Buddy อัตโนมัติ",
    Save = true,
    Callback = function(Value)
...
IQ:AddToggle({
    Name = "Buddy Sword อัตโนมัติ[HOP]",
    Default = false,
    Flag = "Buddy อัตโนมัติ[HOP]",
    Save = true,
    Callback = function(Value)
        _G.Hop = Value
    end    
    ...
    IQ:AddToggle({
        Name = "Soul Guita อัตโนมัติ",
        Default = false,
        Flag = "วิญญาณ อัตโนมัติ",
        Save = true,
        Callback = function(Value)
...
IQ:AddToggle({
    Name = "Soul Guita อัตโนมัติ[HOP]",
    Default = false,
    Flag = "วิญญาณ อัตโนมัติ[HOP]",
    Save = true,
    Callback = function(Value)
        _G.Hop = Value  
    end    
...
IQ:AddToggle({
    Name = "Observation V2 อัตโนมัติ",
    Default = false,
    Flag = "ObservationV2 อัตโนมัติ",
    Save = true,
    Callback = function(Value)
...
local Section = IQ:AddSection({
    Name = "Dual Curset Katana อัตโนมัติ[ไม่ทำงาน]"
})

IQ:AddToggle({
    Name = "Dual Curset Katana อัตโนมัติ",
    Default = false,
    Flag = "DualCursetKatana อัตโนมัติ",
    Save = true,
    Callback = function(Value)
...
IQ:AddToggle({
    Name = "Tushita อัตโนมัติ",
    Default = false,
    Flag = "Tushita อัตโนมัติ",
    Save = true,
    Callback = function(Value)
...
IQ:AddToggle({
    Name = "Tushita อัตโนมัติ[HOP]",
    Default = false,
    Flag = "Tushita อัตโนมัติ[HOP]",
    Save = true,
    Callback = function(Value)
        _G.Hop = Value
    end  
...
IQ:AddToggle({
    Name = "Cavander อัตโนมัติ",
    Default = false,
    Flag = "Cavander อัตโนมัติ",
    Save = true,
    Callback = function(Value)
...
IQ:AddToggle({
    Name = "Cavander อัตโนมัติ[HOP]",
    Default = false,
    Flag = "Cavander อัตโนมัติ[HOP]",
    Save = true,
    Callback = function(Value)
        _G.Hop = Value
    end    
        ...
        IQ:AddToggle({
            Name = "Twin Hook อัตโนมัติ[HOP]",
            Default = false,
            Flag = "Twin อัตโนมัติ[HOP]",
            Save = true,
            Callback = function(Value)
                _G.Hop = Value
            end    
        ...
        IQ:AddLabel("สำหรับคนที่ไม่เข้าใจ นี่คือการตีโง่ๆอัตโนมัติ")

        IQ:AddToggle({
            Name = "ตีหุ่นอัตโนมัติ",
            Default = false,
            Flag = "หุ่นอัตโนมัติ",
            Save = true,
            Callback = function(Value)
        ...
        IQ:AddToggle({
            Name = "ตีหุ่นอัตโนมัติ[HOP]",
            Default = false,
            Flag = "หุ่นอัตโนมัติ[HOP]",
            Save = true,
            Callback = function(Value)
                _G.Hop = Value
            end    
        ...
        local Section = IQ:AddSection({
            Name = "เคียวแยกศักดิ์สิทธิ์"
        })

        IQ:AddToggle({
            Name = "เคียวศักดิ์สิทธิ์อัตโนมัติ",
            Default = false,
            Flag = "ศักดิ์สิทธิ์อัตโนมัติ",
            Save = true,
            Callback = function(Value)
...
ToggleHallow = IQ:AddToggle({
            Name = "เคียวศักดิ์สิทธิ์อัตโนมัติ[HOP]",
            Default = false,
            Flag = "ศักดิ์สิทธิ์อัตโนมัติ[HOP]",
            Save = true,
            Callback = function(Value)
                _G.Hop = Value
            end    
        ...
        IQ:AddToggle({
            Name = "มีดสั้นมืดอัตโนมัติ[HOP]",
            Default = false,
            Flag = "มืดอัตโนมัติ[HOP]",
            Save = true,
            Callback = function(Value)
                _G.Hop = Value
            end    
    ...
    function EquipAllWeapon()
        pcall(function()
            for i,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
                if v:IsA('Tool') and not (v.Name == "เรียกสัตว์ร้ายออกมา" or v.Name == "แหล่งน้ำ" or v.Name == "ตื่น") then
    ...
    local Section = IQ:AddSection({
        Name = "สัตว์ร้ายในทะเล"
    })

    IQ:AddToggle({
        Name = "สัตว์ร้ายในทะเล อัตโนมัติ",
        Default = false,
        Flag = "สัตว์ร้ายในทะเล อัตโนมัติ",
        Save = true,
        Callback = function(Value)
...
IQ:AddToggle({
    Name = "สัตว์ร้ายในทะเล อัตโนมัติ[HOP]",
    Default = false,
    Flag = "สัตว์ร้ายในทะเล อัตโนมัติ[HOP]",
    Save = true,
    Callback = function(Value)
        _G.Hop = Value
    end    
...
IQ:AddToggle({
    Name = "เรียกอัตโนมัติและค้นหาเกาะ Mirrage",
    Default = false,
    Flag = "Mirrage อัตโนมัติ" ,
    Save = true,
    Callback = function(Value)
        _G.dao = Value
            if Value then
...
IQ:AddToggle({
    Name = "ค้นหาเกาะ Mirrage[HOP]",
    Default = false,
    Flag = "Mirrage2 อัตโนมัติ",
    Save = true,
    Callback = function(Value)
        _G.Hop =  Value
    end    
...
spawn(function()
    while wait() do
        ...
        local count = 0
        for i,v in pairs(game.workspace:GetChildren()) do
            if string.find(v.Name,"หีบ") and v:IsA("Part") then
                count10 = count10 + 1
            end
        end
        for i,v in pairs(game.Workspace:GetChildren()) do
            if v.Name == "ตัวแทนจำหน่ายผลไม้ปีศาจ" then
            else
                if string.find(v.Name, "ผลไม้") and v:IsA("Tool") then
                    count = count + 1
                end
                if string.find(v.Name, "ผลไม้") and v:IsA("Model") then
                    count = count + 1
                end
            end
        end
        Fruit:Set("ผลไม้ : "..count)
        Chest:Set("หีบ : "..count10)
        wait(5)
    end
end)

Chest = S:AddLabel("หีบ")

Fruit = S:AddLabel("ผลไม้")

  local Pointstat = S:AddLabel("จำนวน สแต็ส")
    
    spawn(function()
        while wait() do
            pcall(function()
                Pointstat:Set("จำนวน สแต็ส : "..tostring(game:GetService("Players")["LocalPlayer"].Data.Points.Value))
            end)
        end
    end)
    
local Melee = S:AddLabel("หมัด : ")
local Defense = S:AddLabel("ป้องกัน : ")
local Sword = S:AddLabel("ดาบ : ")
local Gun = S:AddLabel("ปืน : ")
local Fruit = S:AddLabel("ผลไม้ : ")
    ...
    spawn(function()
        while wait() do
            pcall(function()
                Defense:Set("ป้องกัน : "..game.Players.localPlayer.Data.Stats.Defense.Level.Value)
            end)
        end
    end)
    ...
    spawn(function()
        while wait() do
            pcall(function()
                Fruit:Set("ผลไม้ : "..game.Players.localPlayer.Data.Stats["ผลไม้ปีศาจ"].Level.Value)
            end)
        end
    end)

S:AddToggle({
    Name = "สถิติอัตโนมัติ Kaitun",
    Default = false,
    Flag = "Kaitun อัตโนมัติ",
    Save = true,
    Callback = function(Value)
        _G.Auto_Stats_Kaitun = Value
    end    
...
local TimeRaid = RA:AddLabel("รอคุกใต้ดิน")

local checkisland = RA:AddLabel("เกาะ : ไม่บุกโจมตี")
...
RA:AddToggle({
    Name = "ปลุกให้ตื่นอัตโนมัติ",
    Default = false,
    Flag = "ปลุกให้ตื่นอัตโนมัติ",
    Save = true,
    Callback = function(Value)
...
local Section = RA:AddSection({
    Name = "เมนู กฎหมายการจู่โจม"
})

RA:AddToggle({
    Name = "กฎหมายซื้อชิปอัตโนมัติ[Raid]",
    Default = false,
    Flag = "กฎหมายชิปอัตโนมัติ",
    Save = true,
    Callback = function(Value)
...
RA:AddToggle({
    Name = "เริ่มกฎหมายการจู่โจม",
    Default = false,
    Flag = "เริ่มกฎหมายการจู่โจมอัตโนมัติ",
    Save = true,
    Callback = function(Value)
...
RA:AddToggle({
    Name = "กฎหมายการฆ่าอัตโนมัติ",
    Default = false,
    Flag = "กฎหมายการฆ่าอัตโนมัติ",
    Save = true,
    Callback = function(Value)
...
if World2 then
    ...
    if World3 then
        ...
        local Section = LC:AddSection({
            Name = "วาปไปหา ปีศาจทะเล"
        })

LC:AddToggle({
    Name = "วาปไปหา ปีศาจทะเล",
    Default = false,
    Flag = "วาปไปหา ปีศาจทะเล",
    Save = true,
    Callback = function(Value)
        for i,v in pairs(game:GetService("Workspace").SeaBeasts:GetChildren()) do
            if v:FindFirstChild("HumanoidRootPart") then
...
LC:AddToggle({
    Name = "วาปไปที่เกาะ Mirage",
    Default = false,
    Flag = "วาปไปที่เกาะ Mirage",
    Save = true,
    Callback = function(Value)
    ...
    while wait() do
        pcall(function()
            for i,v in pairs(game:GetService("Players"):GetPlayers()) do
                if i == 12 then
                    plyserv:Set("ผู้เล่น :".." "..i.." ".."/".." ".."12".." ".."(สูงสุด)")
                elseif i == 1 then
...
local Section = SV:AddSection({
    Name = "เช็คพระจันทร์เต็มดวง"
})

local FM = SV:AddLabel("เวลาเซิร์ฟเวอร์ : " .. function8() .. " | ".. CheckMoon() .. " | " .. function7())

spawn(function()
        while wait() do
            SV:Set("เวลาเซิร์ฟเวอร์ : " .. function8() .. " | ".. CheckMoon() .. " | " .. function7())
                end
            end)
            ...
            local bL = SV:AddLabel("สถานะลูกค้ารายหนึ่ง : " .. tostring(CheckAcientOneStatus()))

local Section = SV:AddSection({
    Name = "เช็คผู้ลากมากดี"
})

local Elite_Hunter_Status = SV:AddLabel("ทะเลที่สามเท่านั้น")
            ...
            while wait() do
                pcall(function()
                    if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban") or game:GetService("Workspace").Enemies:FindFirstChild("Diablo") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre") or game:GetService("Workspace").Enemies:FindFirstChild("Urban") then
                        Elite_Hunter_Status:Set("ผู้ลากมากดี : ✅ เกิด")	
                    else
                        Elite_Hunter_Status:Set("ผู้ลากมากดี : ❌ ไม่เกิด")	
                    end
                end)
            end
        end)
        ...
        spawn(function()
            pcall(function()
                while wait() do
                    EliteProgress:Set("ความคืบหน้าของผู้ลากมากดี : "..game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("นักล่าผู้ลากมากดี","ความคืบหน้า"))
                end
            end)
        end)
      ...
      if World3 then
        spawn(function()
            pcall(function()
                while wait() do
        if game.Workspace._WorldOrigin.Locations:FindFirstChild('เกาะ Mirage') then
...
Mirragecheck = SV:AddLabel("ทะเลที่สามเท่านั้น")

local Section = SV:AddSection({
    Name = "เช็ค Dough King"
})

local MobKilled = SV:AddLabel("ทะเลที่สามเท่านั้น")
...
SV:AddToggle({
	Name = "ค้นหา Hop Moon 3/4 หรือ 4/4",
	Default = false,
    Flag = "FindFM",
    Save = true,
	Callback = function(Value)
...
local Section = SV:AddSection({
    Name = "เซิร์ฟเวอร์อื่น ๆ"
})

        SV:AddTextbox({
            Name = "รหัสงานที่ถูกวางไว้",
            Default = "",
            TextDisappear = true,
            Callback = function(Value)
                _G.Job = Value 
        ...
        SV:AddButton({
            Name = "เข้าร่วมเซิร์ฟเวอร์อีกครั้ง",
            Callback = function()
                ...
                if AutoTeleport then
                    if DontTeleportTheSameNumber then 
                        if #game:GetService("Players"):GetPlayers() - 4  == maxplayers then
                            return warn("มีจำนวนผู้เล่นเท่ากัน (ยกเว้นคุณ)")
                        elseif goodserver == game.JobId then
                            return warn("เซิร์ฟเวอร์ปัจจุบันของคุณเป็นเซิร์ฟเวอร์ที่ว่างมากที่สุดในขณะนี้") 
                        end
                    end
...
D:AddButton({
    Name = "ผลไม้แบบสุ่ม",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ลูกพี่ลูกน้อง","ซื้อ")
      end    
})
...
D:AddToggle({
    Name = "ร้านจำหน่ายผลไม้อัตโนมัติ",
    Default = false,
    Flag = "ร้านจำหน่ายผลไม้อัตโนมัติ",
    Save = true,
    Callback = function(Value)
...
D:AddToggle({
    Name = "วางผลไม้อัตโนมัติ",
    Default = false,
    Flag = "วางผลไม้อัตโนมัติ",
    Save = true,
    Callback = function(Value)
        _G.DropFruit = Value
    end    
            ...
            pcall(function()
                for i,v in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
                    if string.find(v.Name, "ผลไม้") then
                        ...
                        EquipWeapon(v.Name)
                        game:GetService("Players").LocalPlayer.Character:FindFirstChild(SelectFruit).EatRemote:InvokeServer("วาง")
                    end
                end
...
D:AddToggle({
    Name = "นำผลไม้ทั้งหมดมา[75% เตะ]",
    Default = false,
    Flag = "นำผลไม้ทั้งหมดมา[75% เตะ]",
    Save = true,
    Callback = function(Value)
...
AutoPullLever = R:AddToggle({
    Name = "ดึงคันโยกอัตโนมัติ",
    Default = false,
    Flag = "ดึงคันโยกอัตโนมัติ",
    Save = true,
    Callback = function(Value)
        _G.AutoPullLever = Value
		StopTween("ดึงคันโยกอัตโนมัติ")
    end    
})

R:AddToggle({
    Name = "เปิดเผ่า V3 อัตโนมัติ",
    Default = false,
    Flag = "เปิดเผ่า V3 อัตโนมัติ",
    Save = true,
    Callback = function(Value)
        _G.V3 = Value
    end    
...
MoveCamTooMoonToggle = R:AddToggle({
    Name = "ย้ายกล้องไปที่ดวงจันทร์",
    Default = false,
    Flag = "ย้ายกล้องไปที่ดวงจันทร์",
    Save = true,
    Callback = function(Value)
        _G.AutoDooHee = Value
    end    
...
R:AddToggle({
    Name = "ซื้อเกียร์อัตโนมัติ",
    Default = false,
    Flag = "ซื้อเกียร์อัตโนมัติ",
    Save = true,
    Callback = function(Value)
...
R:AddToggle({
    Name = "ฝึกเผ่าอัตโนมัติ",
    Default = false,
    Flag = "ฝึกเผ่าอัตโนมัติ",
    Save = true,
    Callback = function(Value)
    _G.AutoRace = Value
    StardFarm = Value
...
local Section = R:AddSection({
	Name = "วิหารแห่งกาลเวลา"
})

R:AddButton({
    Name = "วาปไปที่ยอดต้นไม้ใหญ่",
    Callback = function()
        TweenTempleLegit()
      end    
})
...
R:AddButton({
  ...
  wait(.1)
  Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
                if game:GetService("Players").LocalPlayer.Data.Race.Value == "เผ่าปลา" then
                wait(1)
                topos(CFrame.new(28224.056640625, 14889.4267578125, -210.5872039794922))
                elseif game:GetService("Players").LocalPlayer.Data.Race.Value == "เผ่ามนุษย์" then
                wait(1)
                topos(CFrame.new(29237.294921875, 14889.4267578125, -206.94955444335938))
                elseif game:GetService("Players").LocalPlayer.Data.Race.Value == "เผ่าหุ่นยนต์" then
                wait(1)
                topos(CFrame.new(28492.4140625, 14894.4267578125, -422.1100158691406))
                elseif game:GetService("Players").LocalPlayer.Data.Race.Value == "เผ่ามีปีก" then
                wait(1)
                topos(CFrame.new(28967.408203125, 14918.0751953125, 234.31198120117188))
                elseif game:GetService("Players").LocalPlayer.Data.Race.Value == "เผ่าผีดิบ" then
                wait(1)
                topos(CFrame.new(28672.720703125, 14889.1279296875, 454.5961608886719))
                elseif game:GetService("Players").LocalPlayer.Data.Race.Value == "เผ่ากระต่าย" then
                wait(1)
...
R:AddToggle({
    Name = "ทดลองใช้งานการกรอกอัตโนมัติ",
    Default = false,
    Flag = "ทดลองใช้งานการกรอกอัตโนมัติ",
    Save = true,
    Callback = function(Value)
...
R:AddToggle({
    Name = "ฆ่าผู้เล่นโดยอัตโนมัติหลังการทดลอง",
    Default = false,
    Flag = "ฆ่าทดลอง",
    Save = true,
    Callback = function(Value)
...
SH:AddButton({
    Name = "Black Leg",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ซื้อBlackLeg")
      end    
})
...
SH:AddButton({
    Name = "Electrol",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ซื้อElectro")
      end    
})
...
SH:AddButton({
    Name = "FishMan Karate",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ซื้อFishmanKarate")
      end    
})
...
SH:AddButton({
    Name = "SuperHuman",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ซื้อSuperhuman")
      end    
})
...
SH:AddButton({
    Name = "Death Step",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ซื้อDeathStep")
      end    
})
...
SH:AddButton({
    Name = "Electric Claw",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ซื้อElectricClaw")
      end    
})
...
SH:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ซื้อSharkmanKarate",true)
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ซื้อSharkmanKarate")
      end    
})
...
SH:AddButton({
    Name = "Dragon Talon",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ซื้อDragonTalon")
      end    
})
...
SH:AddButton({
    Name = "Godhuman",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ซื้อGodhuman")
      end    
})
...
SH:AddButton({
    Name = "ซื้อ ฮาคิ  Buso",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ซื้อHaki","Buso")
      end    
})

SH:AddButton({
    Name = "ซื้อ ฮาคิ Geppo",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ซื้อHaki","Geppo")
      end    
})

SH:AddButton({
    Name = "ซื้อแฟลชสเต็ป(Soru)",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ซื้อHaki","Soru")
      end    
})

SH:AddButton({
    Name = "ซื้อฮาคิสังเกต(Ken)",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("KenTalk","ซื้อ")
      end    
})
...
SH:AddButton({
    Name = "Cutlass Katana",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ซื้อ","Cutlass")
      end    
})
...
SH:AddButton({
    Name = "Katana",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ซื้อ","Katana")
      end    
})
...
SH:AddButton({
    Name = "Iron Mace",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ซื้อ","Iron Mace")
      end    
})
...
SH:AddButton({
    Name = "Dual Katana",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ซื้อ","Duel Katana")
      end    
})
...
SH:AddButton({
    Name = "Triple Katana",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ซื้อ","Triple Katana")
      end    
})
...
SH:AddButton({
    Name = "Pipe",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ซื้อ","Pipe")
      end    
})
...
SH:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ซื้อ","Dual-Headed Blade")
      end    
})
...
SH:AddButton({
    Name = "Bisento",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ซื้อ","Bisento")
      end    
})
...
SH:AddButton({
    Name = "Soul Cane",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ซื้อ","Soul Cane")
      end    
})
...
SH:AddButton({
    Name = "Slingshot",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ซื้อ","Slingshot")
      end    
})
...
SH:AddButton({
    Name = "Musket",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ซื้อ","Musket")
      end    
})
...
SH:AddButton({
    Name = "Flintlock",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ซื้อ","Flintlock")
      end    
})
...
SH:AddButton({
    ...
    Callback = function()
          game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ซื้อ","Refined Flintlock")
      end    
})

SH:AddButton({
    Name = "หินเหล็กไฟที่ผ่านการกลั่นกรอง",
    Callback = function()
        local args = {
            [1] = "ซื้อ",
            [2] = "หินเหล็กไฟที่ผ่านการกลั่นกรอง"
        }
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
      end    
})
...
SH:AddButton({
    Name = "Cannon",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ซื้อ","Cannon")
      end    
})
...
SH:AddButton({
    Name = "Bizarre Rifle [ 250 เอคโทพลาซึม ]",
    Callback = function()
        local A_1 = "เอคโทพลาซึม"
        local A_2 = "ซื้อ"
        local A_3 = 1
...
C:AddButton({
    Name = "Discord link",
    Callback = function(value)
        setclipboard("https://discord.gg/NPtqMTJqej")
    end
})
    ...
    while wait(.1) do
        if LockLevel then
            if game.Players.localPlayer.Data.Level.Value >= LockLevelValue then
                game.Players.localPlayer:Kick("ระดับล็อค : เสร็จสิ้น[ระดับความยากนั้นรอคุณอยู่!]")
            end
        end
    end
end)
...
spawn(function()
    ...
    local Section = C:AddSection({
        Name = "เข้าร่วมอีกครั้ง"
    })

C:AddToggle({
    Name = "เข้าร่วมใหม่โดยอัตโนมัติ",
    Default = false,
    Callback = function(Value)
        _G.AutoRejoin = Value
    end    
        ...
        pcall(function()
            if UseSkill then
                for i,v in pairs(game:GetService("Players").LocalPlayer.PlayerGui.Notifications:GetChildren()) do
                    if v.Name == "แบบฟอร์มการแจ้งเตือน" then
                        if string.find(v.Text,"ล็อคสกิล!") then
                            v:Destroy()
                        end
                    end
                end
...
spawn(function()
    while wait() do
        if _G.BuyAllAib then
            pcall(function()
                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("KenTalk","ซื้อ")
                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ซื้อฮาคิ","Geppo")
                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ซื้อฮาคิ","Buso")
                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ซื้อฮาคิ","Soru")
                if _G.HopBuy then
                    wait(10)
                    Hop()
                end
...
spawn(function()
   ...
   spawn(function()
    ...
    spawn(function()
        ...
        while task.wait() do
        if _G.ChestBypass then
                local ohString1 = "ตั้งค่าทีม"
                local ohString2 = "โจรสลัด"
        ...
        spawn(function()
            ...
            spawn(function()
                ...
                spawn(function()
                    pcall(function()
                        while wait() do
                if game.Workspace._WorldOrigin.Locations:FindFirstChild('เกาะ 1') then
                checkisland:Set(' เกาะ : 1')
                        end
                    end
                    end)
                end)
                ...
                spawn(function()
                    pcall(function()
                        while wait() do
                if game.Workspace._WorldOrigin.Locations:FindFirstChild('เกาะ 2') then
                checkisland:Set('เกาะ : 2')
                        end
                    end
                    end)
                end)
                ...
                spawn(function()
                    pcall(function()
                        while wait() do
                if game.Workspace._WorldOrigin.Locations:FindFirstChild('เกาะ 3') then
                checkisland:Set('เกาะ : 3')
                        end
                    end
                    end)
                end)
                ...
                spawn(function()
                    pcall(function()
                        while wait() do
                if game.Workspace._WorldOrigin.Locations:FindFirstChild('เกาะ 4') then
                checkisland:Set('เกาะ : 4')
                end
                end
                    end)
                end)
                ...
                spawn(function()
                    pcall(function()
                        while wait() do
                if game.Workspace._WorldOrigin.Locations:FindFirstChild('เกาะ 5') then
                checkisland:Set('เกาะ : 5')
                        end
                    end
                    end)
                end)
                        ...
                        while wait() do
                            if _G.AutoMysticIsland then
                                    ...
                                    if game:GetService("Workspace").Map:FindFirstChild("MysticIsland") then
                                        ...
                                        for r, v in pairs(AllNPCS) do
                                            if v.Name == "ตัวแทนจำหน่ายผลไม้ขั้นสูง" then
                        ...
                        while wait(.1) do
                            if _G.AutoStoreFruit then
                                for i,v in pairs(FruitList) do
                                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ร้านค้า",v)
                                end
                            end
                        end
                    end)
        ...
        if _G.AutoElitehunter and World3 then
            pcall(function()
                if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                    ...
                    if _G.AutoEliteHunterHop and game:GetService("ReplicatedStorage").Remotes["CommF_"]:InvokeServer("EliteHunter") == "ตอนนี้ฉันไม่มีอะไรให้คุณเลย ไว้ค่อยมาใหม่" then
                        hop()
                    else
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "UnknownHat8353 Hub(แจ้งเตือน)",
                ...
                OrionLib:MakeNotification({
                    Name = "UnknownHat8353 Hub(แจ้งเตือน)",
                    Content = "[TH] : กรุณายกเลิกภารกิจระดับฟาร์ม (ถ้ามี)",
                    Image = "rbxassetid://8192162908",
                    Time = 9
                })
            end
        ...
        while wait() do
            if _G.AutoObservation then
                if game:GetService("Players").LocalPlayer.VisionRadius.Value >= 3000 then
                    OrionLib:MakeNotification({
                        Name = "UnknownHat8353 BOT",
                        Content = "!!ระดับคุณสูงสุดแล้ว!!",
...
spawn(function()
    ...
    if _G.AutoSharkman then
        if Mybeli <= 2500000 or MyFragment <= 5000 then
            ...
            OrionLib:MakeNotification({
                Name = "UnknownHat8353 Hub",
                Content = "คุณไม่มีเงินหรือเงินม่วง!",
                Image = "rbxassetid://8192162908",
                Time = 5
            })
            end
...
spawn(function()
	...
	if CheckSea(3) then
		...
		if Valk and MirrorFractal then
			local cz = game.ReplicatedStorage.Remotes.CommF_:InvokeServer("RaceV4Progress", "ตรวจสอบ")
			if cz == 1 then
				game.ReplicatedStorage.Remotes.CommF_:InvokeServer("RaceV4Progress", "เริ่ม")
			elseif cz == 2 then
				TweenTempleLegit()
			elseif cz == 3 then
				game.ReplicatedStorage.Remotes.CommF_:InvokeServer("RaceV4Progress", "ดำเนินการต่อ")
			elseif
    ...
    spawn(function()
        while wait() do
            ...
            if game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149052" or game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149431" then
                ...
                OrionLib:MakeNotification({
                    Name = "UnknownHat8353 Hub",
                    Content = "ปิดการค้นหาดวงจันทร์หน่อย",
                    Image = "rbxassetid://10790918487",
                    Time = 5
                })
...
OrionLib:MakeNotification({
        Name = "UnknownHat8353 Hub",
        Content = "โหลดสคริปต์เสร็จเรียบร้อยแล้ว! ตอนนี้คุณสามารถเปิดใช้งานฟังก์ชั่นได้แล้ว!",
        Image = "rbxassetid://10790918487",
        Time = 5
    })
...
OrionLib:MakeNotification({
    Name = "UnknownHat8353 Hub",
    Content = "โหลดการกำหนดค่าเสร็จสมบูรณ์!!",
    Image = "rbxassetid://10790918487",
    Time = 5
})